...
The Human Oversight Systems Lab studies how human oversight of AI systems works (and fails) in practice, with attention to architectural and structural conditions that shape oversight quality.

Contact: brian.moriarty@stevens.edu

## License

The contents of this index (this README and any other prose files in this repository) are licensed under [CC-BY-4.0](LICENSE). Individual PDFs in `papers/` and `slides/` are governed by their respective venue copyrights; consult each item for the applicable terms.
